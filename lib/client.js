window.__ModuleLoader__.load({
	...
	factory: (require) => {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)(ConfigGroup, {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									style: toggleLabelStyle,
									children: t("settings.displayMode.label")
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									style: toggleDescStyle,
									children: t("settings.displayMode.description")
								})] }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("select", {
									style: selectStyle,
									disabled: writing,
									value: config.displayMode,
									onChange: (e) => void patch({ displayMode: e.target.value }),
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
										value: "latest",
										children: t("settings.displayMode.latest")
									}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
										value: "all",
										children: t("settings.displayMode.all")
									})]
								})]
							})
						]
		...
		*/
		...
		let cachedDisplayMode = "latest";
		let displayModeListeners = /* @__PURE__ */ new Set();
		let displayModePolling = false;
		/** Re-fetch config.displayMode and notify all listeners. */
		async function refreshDisplayMode(rpc) {
			try {
				const result = await rpc.call("/suggested-replies", "config.get", {});
...
`;
		...
		function SuggestionActions({ rpc, messageId, sessionId, t }) {
			...
			(0, react.useEffect)(() => {
				...
				if (!displayModePolling) {
					...
					refreshDisplayMode(rpc).finally(() => {
						displayModePolling = false;
					});
				}
				return () => {
			...
			(0, react.useEffect)(() => {
				...
				const onPointerDown = (event) => {
					...
					if (el !== null && el !== void 0 && !el.contains(event.target)) {
						setCollapsed(true);
						saveCollapsed(true);
					}
				};
			...
			const toggleCollapsed = () => {
				...
				setCollapsed(next);
				saveCollapsed(next);
				if (!next) refreshDisplayMode(rpc);
			};
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				ref: wrapRef,
				className: "dsh-sr-wrap",
				style: wrapStyle,
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					...
					className: "dsh-sr-dropdown",
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "dsh-sr-dropdown-header",
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: "dsh-sr-dropdown-title",
								children: t("title")
							}),
							displayMode === "all" && !isLatest && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
								className: "dsh-sr-branch-icon",
								viewBox: "0 0 16 16",
								fill: "none",
								xmlns: "http://www.w3.org/2000/svg",
								children: [
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
										d: "M4 2v8.5a2.5 2.5 0 0 0 2.5 2.5H13",
										stroke: "currentColor",
										strokeWidth: "1.3",
										strokeLinecap: "round"
									}),
						...
						children: state.suggestions.map((text, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							...
							onClick: () => {
								if (displayMode === "all" && !isLatest) {
									rpc.call("/suggested-replies", "suggestions.fork", {
										sessionId,
										messageId,
										draft: text
									});
									setCollapsed(true);
									saveCollapsed(true);
								} else if (cachedSetDraft !== void 0) cachedSetDraft(text);
							},
							children: text
						}, `${state.turn}-${index}`))
					})]
		...
		*/
		...
		function SuggestionBubbles({ inputActions, rpc, sessionId }) {
			(0, react.useEffect)(() => {
			...
			(0, react.useEffect)(() => {
				...
				(async () => {
					try {
						const result = await rpc.call("/suggested-replies", "draft.get", { sessionId });
						if (cancelled) return;
						if (result.ok && result.value.draft !== null) inputActions.setDraft(result.value.draft);
					} catch {}
				})();
				return () => {
					cancelled = true;
